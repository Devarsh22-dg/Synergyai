...
| `SMTP_HOST`, `SMTP_PORT`, `SMTP_USERNAME`, `SMTP_PASSWORD`, `SMTP_FROM_EMAIL` | Signup email verification | Any SMTP account works (e.g. a Gmail/Workspace app password) — see `otp_email.py` |
